        ...
        <div className="registration_content">
          ...
          {/* <form action="">
            <div className="reg_inp">
              ...
              <input
                type="text"
                className="datepicker-here inp_low"
                placeholder="Дата рождения"
                required
              />
              <input type="email" placeholder="Почта" required />
              <input type="text" placeholder="Пароль" required />
              <input type="text" placeholder="Подтвердите пароль" required />
              <input
                type="text"
            ...
            <div className="reg_inf">
              <p className="reg_title">
                Соглашение на обработку личных данных!
              </p>
              <br />
              <p>
                Статья́ — это жанр журналистики, в котором автор ставит задачу
                проанализировать общественные ситуации, процессы, явления,
                прежде всего с точки зрения закономерностей, лежащих в их
                основе.
                <br />
                <br />
                ...
                рассматривает отдельные ситуации как часть более широкого
                явления. Автор аргументированно пишет о своей точке зрения.
                <br />
            ...
            <div className="reg_check">
              ...
              <label for="reg_check">
                Я согласен на обаботку личных данных!
              </label>
            </div>
          ...
          >
            ...
            <div class="reg_inf">
              <p class="reg_title">Соглашение на обработку личных данных!</p>
              <br />
              <p>
                Статья́ — это жанр журналистики, в котором автор ставит задачу
                проанализировать общественные ситуации, процессы, явления,
